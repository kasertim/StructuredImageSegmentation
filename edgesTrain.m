...
dfs={'imWidth',32, 'gtWidth',16, 'nEdgeBins',1, 'nPos',5e5, 'nNeg',5e5, ...
  'nImgs',inf, 'nTrees',16, 'fracFtrs',1/2, 'minCount',1, 'minChild',8, ...
  'maxDepth',64, 'discretize','pca', 'nSamples',256, 'nClasses',2, ...
  'split','gini', 'nOrients',8, 'grdSmooth',0, 'chnSmooth',2, ...
  ...
  'bsdsDir','/home/yiting/Downloads/BSR/BSDS500/data/'};
